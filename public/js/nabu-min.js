...
});*/$('input[name="name"]').on("keyup",function(e){var t=$(this).parent("form");$.ajax({url:t.attr("action"),method:t.attr("method"),data:t.serialize()}).success(function(e){$(".users-result").html(e);console.log(e)})});