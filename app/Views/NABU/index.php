	...
	<style>
		* {margin: 0; padding:0;}
		...
		.wrapper {height: 80%; width: 100%; font-size:0;}
			...
			.discover {display:inline-block; height: 100%; width: 20%; font-size:14px;}
				.discover .recommandations { height:35%; margin-bottom: 5%; width: 100%; background:antiquewhite; }
				.discover .achievements { height:60%; width: 100%; background:antiquewhite; }
...
<body>
	...
	<section class="wrapper">
		<section class="discover">
			<article class="recommandations">Recommandations</article>
			<article class="achievements">Achievements</article>
		</section>
